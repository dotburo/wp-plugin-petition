...
class SwiSignatoryPostType extends SwiPostType {
    ...
    public function init() {
        ...
        $labels = [
            ...
            'archives'              => __( 'Signatory Archives', 'swi-petition' ),
            'attributes'            => __( 'Signatory Attributes', 'swi-petition' ),
            'parent_item_colon'     => __( 'Parent Signatory:', 'swi-petition' ),
            'all_items'             => __( 'All Signatories', 'swi-petition' ),
            'add_new_item'          => __( 'Add New Signatory', 'swi-petition' ),
            'add_new'               => __( 'Add New' ),
            'new_item'              => __( 'New Signatory', 'swi-petition' ),
            'edit_item'             => __( 'Edit Signatory', 'swi-petition' ),
            'update_item'           => __( 'Update Signatory', 'swi-petition' ),
            'view_item'             => __( 'View Signatory', 'swi-petition' ),
            'view_items'            => __( 'View Signatories', 'swi-petition' ),
            'search_items'          => __( 'Search Signatories', 'swi-petition' ),
        ...
        $args = [
            ...
            'description'         => __( 'Signatory post type', 'swi-petition' ),
            'labels'              => $labels,
